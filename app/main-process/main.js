...
app.on('ready', function () {
    ...
    // Apply persisted language preference (falls back to OS locale when unset).
    i18n.init(ProjectWindow.getViewSettings().language);
    ...
    AppMenus.setLanguage(i18n.currentLocale);
